...
PROMPT_BATCH_TO_CLIPS = (
    ...
    "determine which clips are suitable for Shorts.\n"
    "---\n"
    "{blocks_text}\n"
    "---\n\n"
    "Rules (per block):\n"
    ...
    "  action, danger, tension, a dramatic reveal, or a strong silent\n"
    "  emotional beat (e.g. a fight, a chase, a wordless reaction). Only "
    "  treat a block as uninteresting if BOTH Dialogue and Visual suggest\n"
